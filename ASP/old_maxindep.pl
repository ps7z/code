...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fail(X,Y,C,J) :- pathth(X,Y,C,J), indep(X,Y,C,J,W), not ismember(C,X), not ismember(C,Y),jset(J),cset(C), X<Y.
fail(X,Y,C,J) :- pathth(Y,X,C,J), indep(X,Y,C,J,W), not ismember(C,X), not ismember(C,Y),jset(J),cset(C), X<Y.
fail(X,Y,C,J) :- pathhh(X,Y,C,J), indep(X,Y,C,J,W), not ismember(C,X), not ismember(C,Y),jset(J),cset(C), X<Y.
fail(X,Y,C,J) :- pathtt(X,Y,C,J), indep(X,Y,C,J,W), not ismember(C,X), not ismember(C,Y),jset(J),cset(C), X<Y.
...
#minimize{1,X,Y,C,J:fail(X,Y,C,J) }.
